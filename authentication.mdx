...
| `costs.read`         | Permite listar os custos adicionais da loja via API                         |
| `costs.write`        | Permite criar, editar e remover custos adicionais da loja via API           |
| `influencers.read`   | Permite listar influenciadores e seus custos via API                        |
| `influencers.write`  | Permite cadastrar e gerir influenciadores, campanhas, links, cupons e custos|
